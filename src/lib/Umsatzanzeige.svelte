<svelte:options tag="my-umsatzanzeige" />
...
<script>
    ...
    let YearDatasets=JSON.parse(umsaetze)

    console.log(YearDatasets);
...
<!-- Überschrift + Profilbild -->
<div class="mb-4 d-flex justify-content-between align-items-center">
    <h1 style="" class="fs-3 ms-4">Willkommen zurück, Cosimo!</h1>
...
<!-- Card -->
<div class="card mb-3 shadow h-100 d-inline-block">
    <div class="card-body">
        <div>
            <div>
                <style>
                ...
                <h1 class="d-flex flex-row fs-5 text text-muted ms-5">
                    Aktuelles Saldo
                </h1>
                ...
                >
                   <h1 class="fs-1 ms-5">
                        {YearDatasets[YearDatasets.length - 1].umsätze[
                            YearDatasets[YearDatasets.length - 1].umsätze
                                .length - 1
                        ]}€
                        </h1>
                ...
                <div class="d-flex bd-highlight mt-4">
                    <div class="me-auto p-2 bd-highlight ms-5">
                        <button
                            bind:this={btnBar}
                            on:click={onBtnBarClick}
                            class="btn btn-secondary shadow me-2"
                            ><img
                                class="mb-1"
                                src="src/assets/images/barWhite.png"
                                alt=""
                                width="20"
                            /></button
                        >
                        <button
                            bind:this={btnLine}
                            on:click={onBtnLineClick}
                            style="display:none"
                            class="btn btn-secondary shadow me-2"
                            ><img
                                class="mb-1"
                                src="src/assets/images/lineWhite.png"
                                alt=""
                                width="20"
                            /></button
                        >
                        ...
                        <div class="form-check form-switch mt-3">
                            <input
                                ...
                                role="switch"
                                bind:this={input}
                                on:change={changeChartColor}
                                id="flexSwitchCheckDefault"
                            />
                            <label
                                class="form-check-label text-muted"
                                for="flexSwitchCheckDefault"
                                >Switch Chart Colors</label
                            >
                        </div>
                    </div>
...
<!-- Jahre Dropdowns -->
                    <div class="p-2 bd-highlight me-5">
                        ...
                        >
                            <option value={YearDatasets[4].umsätze} id="2022"
                                >2022</option
                            >
                            <option value={YearDatasets[3].umsätze} id="2021"
                                >2021</option
                            >
                            <option value={YearDatasets[2].umsätze} id="2020"
                                >2020</option
                            >
                            <option value={YearDatasets[1].umsätze} id="2019"
                                >2019</option
                            >
                            <option value={YearDatasets[0].umsätze} id="2018"
                                >2018</option
                            >
...
<!-- Monate Dropdowns -->
                        ...
                        >
                            <option
                                value={YearDatasets[4].umsätzeMonths.Januar}
                                id="2022">Januar 2022</option
                            >
                            <option
                                value={YearDatasets[4].umsätzeMonths.Februar}
                                id="2021">Februar 2022</option
                            >
                            <option
                                value={YearDatasets[4].umsätzeMonths.März}
                                id="2020">März 2022</option
                            >
                            <option
                                value={YearDatasets[4].umsätzeMonths.April}
                                id="2019">April 2022</option
                            >
                            <option
                                value={YearDatasets[4].umsätzeMonths.Mai}
                                id="2018">Mai 2022</option
                            >
                            <option
                                value={YearDatasets[4].umsätzeMonths.Juni}
                                id="2022">Juni 2022</option
                            >
                            <option
                                value={YearDatasets[4].umsätzeMonths.Juli}
                                id="2021">Juli 2022</option
                            >
                            <option
                                value={YearDatasets[4].umsätzeMonths.August}
                                id="2020">August 2022</option
                            >
                            <option
                                value={YearDatasets[4].umsätzeMonths.September}
                                id="2019">September 2022</option
                            >
                            <option
                                value={YearDatasets[4].umsätzeMonths.Oktober}
                                id="2018">Oktober 2022</option
                            >
                            <option
                                value={YearDatasets[4].umsätzeMonths.November}
                                id="2022">November 2022</option
                            >
                            <option
                                value={YearDatasets[4].umsätzeMonths.Dezember}
                                id="2021">Dezember 2022</option
                            >
                            <option
                                value={YearDatasets[3].umsätzeMonths.Januar}
                                id="2022">Januar 2021</option
                            >
                            <option
                                value={YearDatasets[3].umsätzeMonths.Februar}
                                id="2021">Februar 2021</option
                            >
                            <option
                                value={YearDatasets[3].umsätzeMonths.März}
                                id="2020">März 2021</option
                            >
                            <option
                                value={YearDatasets[3].umsätzeMonths.April}
                                id="2019">April 2021</option
                            >
                            <option
                                value={YearDatasets[3].umsätzeMonths.Mai}
                                id="2018">Mai 2021</option
                            >
                            <option
                                value={YearDatasets[3].umsätzeMonths.Juni}
                                id="2022">Juni 2021</option
                            >
                            <option
                                value={YearDatasets[3].umsätzeMonths.Juli}
                                id="2021">Juli 2021</option
                            >
                            <option
                                value={YearDatasets[3].umsätzeMonths.August}
                                id="2020">August 2021</option
                            >
                            <option
                                value={YearDatasets[3].umsätzeMonths.September}
                                id="2019">September 2021</option
                            >
                            <option
                                value={YearDatasets[3].umsätzeMonths.Oktober}
                                id="2018">Oktober 2021</option
                            >
                            <option
                                value={YearDatasets[3].umsätzeMonths.November}
                                id="2022">November 2021</option
                            >
                            <option
                                value={YearDatasets[3].umsätzeMonths.Dezember}
                                id="2021">Dezember 2021</option
                            >
                            <option value="null" id="none">Hidden</option>
                        </select>
